...
<div class="container mt-5">
    ...
    <form action="{{ route('vouchers.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" class="form-control" value="{{ old('name') }}" required placeholder="Contoh: Diskon 50K">
        </div>

        <div class="form-group">
            <label for="description">Deskripsi Voucher</label>
            <textarea name="description" class="form-control" placeholder="Deskripsi (optional)">{{ old('description') }}</textarea>
        </div>

        <div class="form-group">
            <label for="discount_amount">Jumlah Potongan (Rp)</label>
            <input type="number" name="discount_amount" class="form-control" value="{{ old('discount_amount') }}" required min="0" placeholder="Contoh: 50000">
        </div>
        ...
        <button type="submit" class="btn btn-primary mt-3">Buat Voucher</button>
    </form>
</div>
</body>
</html>
